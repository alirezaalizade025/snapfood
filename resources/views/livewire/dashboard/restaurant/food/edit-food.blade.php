    ...
    <x-jet-dialog-modal wire:model="showingModal">
            ...
            <section class="max-w-[100rem] p-6 mx-auto bg-indigo-400 rounded-md shadow-md dark:bg-gray-800">
                <form>
                    <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                        ...
                        <div>
                            <label class="text-white dark:text-gray-200" for="passwordConfirmation">Food party <span
                                    wire:click="$set('foodParty')"
                                    class="font-black text-lg cursor-pointer">&times;</span></label>
                        ...
                        <div>
                            <label class="font-medium text-white flex justify-between mb-1">
                                ...
                                @if ($image)
                                    <span class="bg-red-400 rounded-xl p-1 cursor-pointer"
                                        wire:click="$set('image', null)">Remove</span>
                                @endif
                            </label>
                            @if ($image)
                                <img src="{{ asset('storage/photos/food/' . $image) }}"
                                    class="object-cover w-72 h-36 rounded-lg">
                            @elseif ($photo)
        ...
        <x-slot name="footer">
            <div class="flex gap-5 justify-center font-bold text-white">
                ...
                <div class="p-2 rounded bg-indigo-500 cursor-pointer" wire:click="updateFood">save</div>
            </div>
        </x-slot>
